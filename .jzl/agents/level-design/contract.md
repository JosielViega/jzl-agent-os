...
## Objetivo
Responder dependencias do setor level-design para desbloquear agentes do jogo.

## Contrato
Setor level-design define respostas operacionais do seu dominio e nao implementa codigo diretamente.
