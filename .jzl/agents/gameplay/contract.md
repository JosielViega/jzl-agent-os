...
## Objetivo
Responder dependencias do setor gameplay para desbloquear agentes do jogo.

## Contrato
Setor gameplay define respostas operacionais do seu dominio e nao implementa codigo diretamente.
