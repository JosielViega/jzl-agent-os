...
## Objetivo
Responder dependencias do setor performance para desbloquear agentes do jogo.

## Contrato
Setor performance define respostas operacionais do seu dominio e nao implementa codigo diretamente.
