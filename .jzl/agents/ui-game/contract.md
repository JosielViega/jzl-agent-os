...
## Objetivo
Responder dependencias do setor ui-game para desbloquear agentes do jogo.

## Contrato
Setor ui-game define respostas operacionais do seu dominio e nao implementa codigo diretamente.
