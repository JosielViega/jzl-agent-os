...
## Objetivo
Responder dependencias do setor audio para desbloquear agentes do jogo.

## Contrato
Setor audio define respostas operacionais do seu dominio e nao implementa codigo diretamente.
